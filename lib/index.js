...
Falkonry.prototype.getOutput = function (pipeline, done) {
  var _this = this;
  return _this.service.getOutput(pipeline, function(error, response){
    if(error) {
      if(typeof done === 'function') {
        return done(Utils.wrapError(null, error), null);
      }
    }
    else {
      if(typeof done === 'function') {
