...
Falkonry.prototype.addInput = function (eventbuffer, dataType, data, done) {
  var _this = this;
  return _this.service.addInputData(eventbuffer, dataType, data, function(error, response, code){
    if(error) {
      if(typeof done === 'function') {
        return done(Utils.wrapError(code, error), null);
      }
...
Falkonry.prototype.addInputFromStream = function (eventbuffer, dataType, data, done) {
  var _this = this;
  return _this.service.addInputStream(eventbuffer, dataType, data, function(error, response, code){
    if(error) {
      if(typeof done === 'function') {
        return done(Utils.wrapError(code, error), null);
      }
...
Falkonry.prototype.createPublication = function (eventbuffer, publication, done) {
  var _this    = this;
  ...
  if(!publication instanceof Publication) {
    ...
    return _this.service.createPublication(eventbuffer, publication, function(error, response, code){
      if(error) {
        if(typeof done === 'function') {
          return done(Utils.wrapError(code, error), null);
        }
