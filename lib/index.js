...
Falkonry.prototype.addVerification = function (pipeline, dataType ,data,done){
  var _this = this;
  return _this.service.addVerificationData(pipeline, dataType ,data, function(error,response, code){
    if(error) {
      if(typeof done === 'function'){
        return done(Utils.wrapError(code, error), null);
      }
