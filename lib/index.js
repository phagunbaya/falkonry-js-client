...
Falkonry.prototype.addFacts = function (pipeline, dataType ,data, options, done){
  var _this = this;
  return _this.service.addFactsData(pipeline, dataType ,data, options, function(error,response, code){
    if(error) {
      if(typeof done === 'function'){
        return done(Utils.wrapError(code, error), null);
      }
 ...
 *
 * addFactsFromStream
 *  To add facts stream to the Pipeline
 *
 * @param {String} pipeline
 * @param {String} dataType
 * @param {Stream} data
...
Falkonry.prototype.addFactsFromStream = function(pipeline, dataType, data, options, done){
  var _this = this;
  return _this.service.addFactsStream(pipeline,dataType,data, options, function(error,response,code){
    if(error){
      if(typeof done === 'function'){
        return done(Utils.wrapError(code, error), null);
      }
