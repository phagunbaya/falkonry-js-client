      ...
      return _this.http.get(path, function (error, response, code) {
        if (error) {
          ...
          if (pipelineDetails["outflowStatus"] == "CLOSED") {
            ...
            var result = "";
            //console.log("Request Headers : " + request/*getAllResponseHeaders().getResponseHeader("x-falkonry-data-offset")*/);
            request.on('response', function (response) {
              //console.log("ResponseBody : " + response.body);// + request.getResponseHeader("x-falkonry-data-offset"));
              //console.log(".header[] : " + response.headers["x-falkonry-data-offset"]);
              start = response.headers["x-falkonry-data-offset"];
              url = '/Pipeline/' + pipeline +'/output?startTime='+start;
              //console.log(url);// + request.getResponseHeader("x-falkonry-data-offset"));
              //console.log("Headers : " + request.getHeader("x-falkonry-data-offset", response.getAllResponseHeaders));// + request.getResponseHeader("x-falkonry-data-offset"));
              //console.log("ResponseType : " + response.responseType);// + request.getResponseHeader("x-falkonry-data-offset"));
            })
