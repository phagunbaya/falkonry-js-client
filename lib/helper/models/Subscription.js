...
Subscription.prototype.setHistorian = function(isHistorian) {
  var _this = this;
  _this.raw['isHistorian'] = isHistorian;
  return _this;
};

Subscription.prototype.getHistorian = function() {
  var _this = this;
  return _this.raw['isHistorian'];
};
