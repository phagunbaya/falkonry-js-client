...
function Pipeline(pipeline) {
  var _this = this;
  _this.raw = pipeline || {'dataFormat' : 'application/json'};
  ...
  if(!_this.raw.dataFormat) {
    _this.raw.dataFormat = 'application/json';
  }
...
Pipeline.prototype.setDataFormat = function(dFormat) {
  var _this = this;
  _this.raw['dataFormat'] = dFormat;
  return _this;
};

Pipeline.prototype.getDataFormat = function() {
  var _this = this;
  return _this.raw['dataFormat'];
};
